	...
	<div class="mbody">
		...
		<table width="600" border="1" cellpadding="1" cellspacing="1">
			...
			while ($product=mysqli_fetch_assoc($result)) 
			{
				...
				echo"<td>
				<a href='Edit_Product.php?ID=".$product['ID']."' style='text-decoration: none' />Edit</a>
				<a href='Delete_Product.php?ID=".$product['ID']."' style='text-decoration: none;' />Delete</a>
				<a href='print_product.php?ID=".$product['ID']."' onclick='myWindow=window.open(this.ref 'newwindow','width=300,height=250')';>Print</a>
				</td>";				
				echo "</tr>";
			}
			?>
