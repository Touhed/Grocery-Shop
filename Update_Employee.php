	...
	<div class="mbody">
		<form action="Update_Employee.php" method="POST">
			...
			<div class="php">
				...
				$sql="UPDATE `tb_emoloyee` SET Employee_Name = '".$_POST['ename']."',Employee_Address = '".$_POST['eaddress']."',Employee_Contact = '".$_POST['econtact']."',Employee_Email = '".$_POST['eemail']."' WHERE Employee_ID = '".$_POST['eid']."'";
