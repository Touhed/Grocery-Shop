...
<style> 
	...
	<div class="mbody">
		<h1>Search Result On Product Information</h1>
		<form action="Search_Product_Connect.php
		" method="POST" >
		<?php
		...
		<table width="600" border="1" cellpadding="1" cellspacing="1">
			...
			if($searchKeyword)
			{
			$sql="SELECT * FROM `tb_product` WHERE '".$searchKeyword."' IN (ID,Name,Company,Quantity,Price);";
