...
<style> 
	...
	<div class="php">
			...
			$sql="INSERT INTO tb_employee(Employee_ID,Employee_Name,Employee_Address,Employee_Contact,Employee_Email)VALUES('$_POST[eid]','$_POST[ename]','$_POST[eaddress]','$_POST[econtact]','$_POST[eemail]')";
		...
		<form action="Employee_Connect.php" method="POST">
			<h1>Employee Details Form</h1>

			Employee_ID:</br>
				<input type="text" name="eid" value=""></br>
		
			Employee_Name:</br>
				<input type="text" name="ename" value=""></br>
				
			Employee_Address:</br>
				<input type="text" name="eaddress" value=""></br>
				
			Employee_Contact:</br>
				<input type="text" name="econtact" value=""></br>
			
			Employee_Email:</br>
				<input type="text" name="eemail" value=""></br>
