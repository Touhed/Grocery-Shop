...
<style> 
	...
	<div class="mbody">
		...
		while ($customer=mysqli_fetch_assoc($result)) 
		{
			...
			echo"<td>".$customer['Customer_Contact']."</td>";
			echo"<td>".$customer['Customer_Email']."</td>";
			echo"<td>
				<a href='Edit_Customer.php?ID=".$customer['Customer_ID']."' style='text-decoration: none' />Edit</a>
				<a href='Delete_Customer.php?ID=".$customer['Customer_ID']."' style='text-decoration: none;' />Delete</a>
				<a href='print_Customer.php?ID=".$customer['Customer_ID']."' onclick='myWindow=window.open(this.ref 'newwindow','width=300,height=250')';>Print</a>
				</td>";			
			echo "</tr>";
		}
		?>
