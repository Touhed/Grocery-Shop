...
<style> 
	...
	<div class="mbody">
		<div class="php">
			...
			$sql="INSERT INTO tb_payment(Payment_ID,Date,Type,Price,Vat,Total_Cost)VALUES('$_POST[pid]','$_POST[date]','$_POST[type]','$_POST[price]','$_POST[vat]','$_POST[totalcost]')";
		...
		Total_Cost:</br>
			<input type="text" name="totalcost" value=""></br>
